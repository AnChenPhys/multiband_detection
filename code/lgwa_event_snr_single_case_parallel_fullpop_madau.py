...
def main():
    ...
    out_summary = args.out_summary or f'lgwa_event_snr/lgwa_event_snr_{tag}.txt'
    out_samples = args.out_samples or f'lgwa_event_snr/lgwa_event_snr_{tag}_samples.txt'
