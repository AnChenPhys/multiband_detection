...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Parallel FullPop+Madau AMIGO event sampler using joint-polarization SNR threshold'
    )
...
def save_detected_samples(path, arrays, summary):
    ...
    header_lines = [
        'FullPop+Madau AMIGO events with joint-polarization SNR above threshold',
        f'summary = {summary}',
...
def main():
    ...
    out_summary = args.out_summary or f'amigo_event_snr/amigo_event_snr_{tag}.txt'
    out_samples = args.out_samples or f'amigo_event_snr/amigo_event_snr_{tag}_samples.txt'
